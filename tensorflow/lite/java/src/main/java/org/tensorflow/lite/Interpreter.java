...
public final class Interpreter extends InterpreterImpl implements InterpreterApi {
  ...
  public Interpreter(@NonNull File modelFile) {
    this(modelFile, /*options = */ null, null);
  }
   ...
   *     model.
   */
  public Interpreter(@NonNull File modelFile, Options options, long[] resolverPtr) {
    this(new NativeInterpreterWrapperExperimental(modelFile.getAbsolutePath(), options, resolverPtr));
  }
   ...
   *     direct {@code ByteBuffer} of nativeOrder.
   */
  public Interpreter(@NonNull ByteBuffer byteBuffer, Options options, long[] resolverPtr) {
    this(new NativeInterpreterWrapperExperimental(byteBuffer, options, resolverPtr));
  }
