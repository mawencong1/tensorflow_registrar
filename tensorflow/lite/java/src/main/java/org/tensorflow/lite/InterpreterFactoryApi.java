...
public interface InterpreterFactoryApi {
   ...
   *     model.
   */
  InterpreterApi create(@NonNull File modelFile, InterpreterApi.Options options, long[] resolverPtr);
   ...
   */
  InterpreterApi create(@NonNull ByteBuffer byteBuffer, InterpreterApi.Options options, long[] resolverPtr);
