...
class InterpreterImpl implements InterpreterApi {
   ...
   *     model.
   */
  InterpreterImpl(@NonNull File modelFile, Options options, long[] resolverPtr) {
    wrapper = new NativeInterpreterWrapper(modelFile.getAbsolutePath(), options, resolverPtr);
  }
   ...
   */
  InterpreterImpl(@NonNull ByteBuffer byteBuffer, Options options, long[] resolverPtr) {
    wrapper = new NativeInterpreterWrapper(byteBuffer, options, resolverPtr);
  }
