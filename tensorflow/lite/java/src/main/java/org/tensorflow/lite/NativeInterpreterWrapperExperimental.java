...
final class NativeInterpreterWrapperExperimental extends NativeInterpreterWrapper {
  ...
  NativeInterpreterWrapperExperimental(String modelPath, InterpreterImpl.Options options, long[] resolverPtr) {
    super(modelPath, options, resolverPtr);
  }

  NativeInterpreterWrapperExperimental(ByteBuffer buffer, InterpreterImpl.Options options, long[] resolverPtr) {
    super(buffer, options, resolverPtr);
  }
