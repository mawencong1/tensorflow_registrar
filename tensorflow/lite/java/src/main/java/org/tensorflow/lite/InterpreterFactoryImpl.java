...
class InterpreterFactoryImpl implements InterpreterFactoryApi {
  ...
  @Override
  public InterpreterApi create(@NonNull File modelFile, InterpreterApi.Options options, long[] resolverPtr) {
    return new InterpreterImpl(
        modelFile, options == null ? null : new InterpreterImpl.Options(options), resolverPtr);
  }

  @Override
  public InterpreterApi create(@NonNull ByteBuffer byteBuffer, InterpreterApi.Options options, long[] resolverPtr) {
    return new InterpreterImpl(
        byteBuffer, options == null ? null : new InterpreterImpl.Options(options), resolverPtr);
  }
