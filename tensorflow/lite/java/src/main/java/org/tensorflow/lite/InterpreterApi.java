...
public interface InterpreterApi extends AutoCloseable {
  ...
  static InterpreterApi create(@NonNull File modelFile, InterpreterApi.Options options, long[] resolverPtr) {
    ...
    return factory.create(modelFile, options, resolverPtr);
  }
   ...
   */
  @SuppressWarnings("StaticOrDefaultInterfaceMethod")
  static InterpreterApi create(@NonNull ByteBuffer byteBuffer, InterpreterApi.Options options, long[] resolverPtr) {
    TfLiteRuntime runtime = (options == null ? null : options.getRuntime());
    InterpreterFactoryApi factory = TensorFlowLite.getFactory(runtime);
    return factory.create(byteBuffer, options, resolverPtr);
  }
