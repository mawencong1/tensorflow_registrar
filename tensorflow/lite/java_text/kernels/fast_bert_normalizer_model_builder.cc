...
#include "tensorflow/lite/java_text/kernels/fast_bert_normalizer_model_builder.h"
...
#include "tensorflow/lite/java_text/kernels/fast_bert_normalizer.h"
#include "tensorflow/lite/java_text/kernels/fast_bert_normalizer_model_generated.h"

namespace tensorflow {
namespace text {
namespace {
// Adapted from CaseFoldUTF8Op::Compute() in
// https://github.com/tensorflow/text/blob/master/tensorflow/lite/java_text/kernels/normalize_kernels.cc.
